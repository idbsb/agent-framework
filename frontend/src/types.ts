...
export type GraphNode = { id: string; name: string; type: string; formal_type?: string; category?: string; standard_job_title?: string; standard_skill_name?: string; job_family?: string; technical_domain?: string; skill_category?: string; batch_status?: "NEW"|"UPDATED"; batch_id?: string; is_emerging?: boolean; job_status?: string; incremental_jd_count?: number; company_count?: number; source_count?: number; evidence_count?: number; first_seen?: string; last_seen?: string; updated_at?: string; graph_version?: string; evidence_ids?: string[]; core_skills?: string[] };
