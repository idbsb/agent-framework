...
export type GraphNode = { id: string; name: string; type: string; formal_type?: string; category?: string; standard_job_title?: string; standard_skill_name?: string; job_family?: string; technical_domain?: string; skill_category?: string; batch_status?: "NEW"|"UPDATED"; batch_id?: string; is_emerging?: boolean; job_status?: string; jd_count?: number; incremental_jd_count?: number; company_count?: number; source_count?: number; evidence_count?: number; first_seen?: string; last_seen?: string; updated_at?: string; graph_version?: string; evidence_ids?: string[]; core_skills?: string[] };
export type GraphEdge = { id: string; source: string; target: string; frequency: number; edge_type?: string; relation?: string; relation_type?: string; job_title?: string; skill_name?: string; mention_count?: number; sample_size?: number; source_count?: number; confidence?: number; importance?: string; skill_level?: string; evidence?: string; evidence_jd_ids: string[]; evidence_count: number; batch_status?: "NEW"|"UPDATED"; batch_id?: string; incremental_evidence_ids?: string[] };
export type GraphPayload = { profile_source?: string; profile_version?: number | null; profile_id?: string | null; profile_fingerprint?: string | null; available: boolean; status: string; source_type?: string; source_label: string; source_file?: string; notice: string; nodes: GraphNode[]; edges: GraphEdge[]; summary: Record<string, number>; baseline_summary?: Record<string,number>; graph_change?: Record<string,number>; graph_version?: string; batch_id?: string; job_title?: string };
